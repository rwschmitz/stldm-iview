            ...
            <a href="https://newtpress.com/stldm-iview/menu-item-3" id="mainDropDown1" class="nav-link nav-item" data-target=".navbar-collapse.show">
                <button class="nav-btn underline">menu item 3</button>
                    <div id="subdrop1" class="dropdown-menu">
                        <li><a href="https://newtpress.com/stldm-iview/menu-item-1"><button class="nav-drop-btn underline">Sub-menu item 1</button></li></a>
                        <li><a href="https://newtpress.com/stldm-iview/menu-item-2"><button class="nav-drop-btn underline">Sub-menu item 2</button></li></a>
                        <li><a href="https://newtpress.com/stldm-iview/menu-item-3"><button class="nav-drop-btn underline">Sub-menu item 3</button></li></a>
                    </div>
            </a>
